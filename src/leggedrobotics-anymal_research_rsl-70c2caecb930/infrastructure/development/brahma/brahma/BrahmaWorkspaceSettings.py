...
class BrahmaWorkspaceSettings:
    ...
    def __init__(self):
        ...
        if os.path.isdir(ros_installation_dir):
            ros_versions = os.listdir("/opt/ros")
    ...
    def removeRepository(self, rel_path):
        ...
        :type rel_path: str
        '''
        self.git_repositories.pop(name, None)
    ...
    def settingsFile(self, workpace_dir):
        '''
        :returns: Path of the settings file
        :rtype: str
        '''
        return workpace_dir + '/.brahma/' + WORKSPACE_SETTINGS_FILE
