...
# Setup verbs
verbs = ['create', 'init', 'config', 'update', 'setup', 'info']
...
def brahma_main():
    ...
    main_parser = argparse.ArgumentParser(description='brahma is a managing tool for catkin workspaces that are version controlled with git.\n',
