...
macro(ADD_PYTEST_WITH_COVERAGE TEST_PATH PYTHON_MODULE)
  ...
  set(PYTESTS_TEMP  ${PYTESTS})
  set(PYTESTS "${COVERAGE_EXECUTABLE} run --source=${PYTHON_MODULE} --rcfile=${COVERAGE_CONFIG} ${PYTESTS}") # Make sure we execute tests with the right python version
  add_pytests(${TEST_PATH} OPTIONS "-o cache_dir=${CACHE_OUTPUT_DIR}")
  set(PYTESTS ${PYTESTS_TEMP})
