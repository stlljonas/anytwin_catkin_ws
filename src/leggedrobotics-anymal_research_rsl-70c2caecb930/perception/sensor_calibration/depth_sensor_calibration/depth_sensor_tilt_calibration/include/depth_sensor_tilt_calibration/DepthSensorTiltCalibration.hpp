/*
 * DepthSensorTiltCalibration.hpp
 *
...
class DepthSensorTiltCalibration
{
 public:
  DepthSensorTiltCalibration(ros::NodeHandle& nodeHandle);
  virtual ~DepthSensorTiltCalibration();
 ...
 private:
  ...
  unsigned int maxSnapshots_ = 0;

  //! Current number of point clouds.
  unsigned int nSnapshots_ = 0;
