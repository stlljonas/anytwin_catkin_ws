...
class Action(ActionBase):
    ...
    def __init__(self, relay):
        ...
        self.actions = [self._drop_payload_left,
    ...
    # Actions.
    def _drop_payload_left(self):
        rospy.loginfo('drop_payload_left.py: Dropping payload to the left.')
        self.goal = load_action_from_file(self.directory + '/drop_payload_left.yaml')
        self._send_goal()
        return True
