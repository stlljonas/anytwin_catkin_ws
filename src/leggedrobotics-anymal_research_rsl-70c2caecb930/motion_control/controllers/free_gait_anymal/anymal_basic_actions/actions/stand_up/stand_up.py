...
from anymal_actions_common import trigger_payload_service_call, all_feet_in_open_contact, set_checking_for_state_estimator, \
    wait_for_active_controller, set_zero_velocity_update_for_state_estimator, reset_free_gait_controller
...
class Action(AnymalPythonAction):
    def __init__(self, relay):
        ...
        self.directory = get_package_path("anymal_basic_actions") + "/actions/stand_up"
