/*
 * SwingTrajectoryGeneratorSplineOptVisualizer.cpp
 *
...
SwingTrajectoryGeneratorSplineOptVisualizer::SwingTrajectoryGeneratorSplineOptVisualizer()
{
  markerArray_.markers.resize(4, visualization_msgs::Marker());
}

bool SwingTrajectoryGeneratorSplineOptVisualizer::initialize(ros::NodeHandle& nodeHandle, const std::string& topic) {
...
bool SwingTrajectoryGeneratorSplineOptVisualizer::shutdown() {
  publisher_.shutdown();
  return true;
}

bool SwingTrajectoryGeneratorSplineOptVisualizer::update(const loco::SwingTrajectoryGeneratorSplineOpt& generator) {
...
bool SwingTrajectoryGeneratorSplineOptVisualizer::publish() {
