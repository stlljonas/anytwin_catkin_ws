/*
 * FootholdGeneratorInvertedPendulumDynamicWalk.hpp
 *
...
class FootholdGeneratorInvertedPendulumDynamicWalk : public FootholdGeneratorInvertedPendulumBase {
 public:
  FootholdGeneratorInvertedPendulumDynamicWalk(
      WholeBody& wholeBody,
      TerrainModelBase& terrain,
      ContactScheduleZmp& contactSchedule);

  ~FootholdGeneratorInvertedPendulumDynamicWalk() override = default;
