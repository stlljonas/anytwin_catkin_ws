...
TEST(LocomotionControllerTest, test) {
  ...
  std::shared_ptr<loco::TorsoAnymal> torso_;
  ...
  std::shared_ptr<loco::LimbCoordinatorDeprecated> limbCoordinator_;
  ...
  std::shared_ptr<loco::VirtualModelControllerContactInvariantDamper> virtualModelController_;
  std::shared_ptr<loco::LocomotionController> locomotionController_;
  ...
  /* create terrain */
   ...
   /* create torso */
   torso_.reset(new loco::TorsoAnymal(robotModel_));
   ...
   limbCoordinator_.reset(new loco::LimbCoordinatorDeprecated(legs_.get(), torso_.get(), gaitPatternAPS_.get()));
   ...
   virtualModelController_.reset(new loco::VirtualModelControllerContactInvariantDamper(legs_, torso_, contactForceDistribution_));
   locomotionController_.reset(new loco::LocomotionController(legs_.get(), torso_.get(), terrainPerception_.get(), contactDetector_.get(), limbCoordinator_.get(), footPlacementStrategy_.get(), torsoController_.get(), virtualModelController_.get(), contactForceDistribution_.get(), parameterSet_.get()));
