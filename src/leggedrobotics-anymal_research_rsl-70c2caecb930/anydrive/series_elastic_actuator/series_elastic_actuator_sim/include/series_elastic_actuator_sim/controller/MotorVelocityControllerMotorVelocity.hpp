/*!
 * @file    MotorVelocityControllerMotorVelocity.hpp
...
class MotorVelocityControllerMotorVelocity: public ControllerBase
{
 public:
  MotorVelocityControllerMotorVelocity();
  virtual ~MotorVelocityControllerMotorVelocity();
