...
std::string nodeToOrderedString(const YamlNode& node, YamlNode::EmitterFormat format) {
  YAML::Emitter emitter;
  if (format == YamlNode::EmitterFormat::ONE_LINE) {
    emitter.SetMapFormat(YAML::EMITTER_MANIP::Flow);
