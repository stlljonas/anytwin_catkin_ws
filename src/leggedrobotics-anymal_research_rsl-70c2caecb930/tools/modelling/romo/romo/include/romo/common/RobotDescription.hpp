...
struct RobotDescription {
 ...
 private:
  // Helper functions for disabling unimplemented features
  BOOST_TTI_HAS_STATIC_MEMBER_FUNCTION(getNumDofLimbImpl)
  using HasGetNumDofLimbImpl = has_static_member_function_getNumDofLimbImpl<ConcreteDefinitions, unsigned int ()>;
  BOOST_TTI_HAS_STATIC_MEMBER_FUNCTION(getWheelDiameterImpl)
  using HasGetWheelDiameterImpl = has_static_member_function_getWheelDiameterImpl<ConcreteDefinitions, double ()>;
  BOOST_TTI_HAS_STATIC_MEMBER_FUNCTION(getWheelIndexInJImpl)
  using HasGetWheelIndexInJImpl = has_static_member_function_getWheelIndexInJImpl<ConcreteDefinitions, unsigned int (LimbEnum)>;
 ...
 public:
   ...
   */
  template<typename RType = unsigned int>
  inline static constexpr auto getNumDofLimb()
  -> typename std::enable_if<HasGetNumDofLimbImpl::value, RType>::type
  { return ConcreteDefinitions::getNumDofLimbImpl(); }
  ...
  inline static constexpr auto getWheelDiameter(LimbEnum limb)
  -> typename std::enable_if<HasGetWheelDiameterImpl::value, RType>::type
  { return ConcreteDefinitions::getWheelDiameterImpl(); /* issue: Not passing LimbEnum */ }

  //! @return index of the endeffector in the limb joints list
  template<typename RType = unsigned int>
  inline static constexpr auto getWheelIndexInJ(LimbEnum limb)
  -> typename std::enable_if<HasGetWheelIndexInJImpl::value, RType>::type
  { return ConcreteDefinitions::getWheelIndexInJImpl(limb); }
   ...
   *        This is safe since the compiler will complain if the user specifies a wrong single type.
