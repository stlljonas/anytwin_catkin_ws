...
class LimitsInterface {
 public:
  ...
  virtual double getActuatorMinCommandEffort(ActuatorEnum actuator) const = 0;
  virtual double getActuatorMaxCommandEffort(ActuatorEnum actuator) const = 0;
  ...
  virtual double getJointMinCommandEffort(JointEnum joint) const = 0;
  virtual double getJointMaxCommandEffort(JointEnum joint) const = 0;
};
