...
TEST(Interpolator, InterpolatorDouble) {  // NOLINT
  using Interpolation = robot_utils::LinearInterpolation;
  using ValueType = double;

  robot_utils::Interpolator<ValueType, Interpolation> interpolator;
  ...
  for (double time = 0.0; time <= duration + timestep; /*advance at the bottom of for loop*/) {
    ...
    double t = robot_utils::mapTo01Range(time, 0.0, duration);
    double s, dsdt;
...
TEST(Interpolator, InterpolatorUnevenTimestep) {  // NOLINT
  using Interpolation = robot_utils::LinearInterpolation;
  using ValueType = double;
...
TEST(Interpolator, InterpolatorEigenMatrix) {  // NOLINT
...
TEST(Interpolator, InterpolatorEigenFifthOrder) {  // NOLINT
...
TEST(Interpolator, PoseInterpolator) {  // NOLINT
  using Interpolation = robot_utils::LinearInterpolation;
  ...
  robot_utils::Interpolator<ValueType, Interpolation> poseInterpolator;
