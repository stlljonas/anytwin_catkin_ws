...
TEST(Interpolation, LinearInterpolation) {  // NOLINT
  robot_utils::LinearInterpolation linearInterpolation;
...
TEST(Interpolation, BasicFifthOrderInterpolation) {  // NOLINT
  robot_utils::BasicFifthOrderInterpolation basicFifthOrderInterpolation;
