...
class Line : public Polygon {
 public:
  Line();
  explicit Line(const VertexList& vertices, robot_utils::geometry::VertexOrder vertexOrder = VertexOrder::CounterClockWise);
  explicit Line(VertexList&& vertices, robot_utils::geometry::VertexOrder vertexOrder = VertexOrder::CounterClockWise);
 ...
 protected:
  bool isPointInPolygonInternal(const Position2d& point, double tol) const override;
};
