...
template <typename ValueType_, typename InterpolationType_>
bool Interpolator<ValueType_, InterpolationType_>::initialize(const ValueType_& initialValue, const ValueType_& finalValue,
...
template <typename ValueType_, typename InterpolationType_>
const typename Interpolator<ValueType_, InterpolationType_>::DerivativeType&
Interpolator<ValueType_, InterpolationType_>::getCurrentDerivative() const {
