...
#include "basic_filters/CumulativeMovingAverageFilter.hpp"
...
class AverageForceCalibrator : public ForceCalibratorBase {
 ...
 public:
  explicit AverageForceCalibrator(const std::string& name, const Config& config = Config());
  ...
  bool startCalibration(bool wait) override;
 ...
 protected:
  ...
  basic_filters::CumulativeMovingAverageFilter<kindr::WrenchD> cmaFilter_;
