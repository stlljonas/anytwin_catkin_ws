...
class Key {
 public:
  ...
  constexpr Key(const Enum_ e, const char* name, const IdType id) noexcept : enum_{e}, name_{name}, id_{id} {}

  constexpr Key(const Enum_ e, const char* name) noexcept : enum_{e}, name_{name}, id_{static_cast<IdType>(e)} {}
