 ...
 *
 *            std_utils::typestring<'H', 'e', 'l', 'l', 'o', '!'>
 *
...
auto tycatT(typestring<A...>, typestring<B...>, X... x) -> decltype(tycatT(typestring<A..., B...>(), x...));

template <char... X>
auto tycatT(typestring<X...>) -> typestring<X...>;
...
/* 2^0 = 1 */
#define TYPESTRING1(n, x) std_utils::tygrab<0x##n##0>(x)

/* 2^1 = 2 */
#define TYPESTRING2(n, x) std_utils::tygrab<0x##n##0>(x), std_utils::tygrab<0x##n##1>(x)

/* 2^2 = 2 */
#define TYPESTRING4(n, x) \
  std_utils::tygrab<0x##n##0>(x), std_utils::tygrab<0x##n##1>(x), std_utils::tygrab<0x##n##2>(x), std_utils::tygrab<0x##n##3>(x)

/* 2^3 = 8 */
#define TYPESTRING8(n, x)                                                                                                         \
  std_utils::tygrab<0x##n##0>(x), std_utils::tygrab<0x##n##1>(x), std_utils::tygrab<0x##n##2>(x), std_utils::tygrab<0x##n##3>(x), \
      std_utils::tygrab<0x##n##4>(x), std_utils::tygrab<0x##n##5>(x), std_utils::tygrab<0x##n##6>(x), std_utils::tygrab<0x##n##7>(x)

/* 2^4 = 16 */
#define TYPESTRING16(n, x)                                                                                                            \
  std_utils::tygrab<0x##n##0>(x), std_utils::tygrab<0x##n##1>(x), std_utils::tygrab<0x##n##2>(x), std_utils::tygrab<0x##n##3>(x),     \
      std_utils::tygrab<0x##n##4>(x), std_utils::tygrab<0x##n##5>(x), std_utils::tygrab<0x##n##6>(x), std_utils::tygrab<0x##n##7>(x), \
      std_utils::tygrab<0x##n##8>(x), std_utils::tygrab<0x##n##9>(x), std_utils::tygrab<0x##n##A>(x), std_utils::tygrab<0x##n##B>(x), \
      std_utils::tygrab<0x##n##C>(x), std_utils::tygrab<0x##n##D>(x), std_utils::tygrab<0x##n##E>(x), std_utils::tygrab<0x##n##F>(x)

/* 2^5 = 32 */
#define TYPESTRING32(n, x) TYPESTRING16(n##0, x), TYPESTRING16(n##1, x)

/* 2^6 = 64 */
#define TYPESTRING64(n, x) TYPESTRING16(n##0, x), TYPESTRING16(n##1, x), TYPESTRING16(n##2, x), TYPESTRING16(n##3, x)

/* 2^7 = 128 */
#define TYPESTRING128(n, x)                                                                                          \
  TYPESTRING16(n##0, x), TYPESTRING16(n##1, x), TYPESTRING16(n##2, x), TYPESTRING16(n##3, x), TYPESTRING16(n##4, x), \
      TYPESTRING16(n##5, x), TYPESTRING16(n##6, x), TYPESTRING16(n##7, x)

/* 2^8 = 256 */
#define TYPESTRING256(n, x)                                                                                              \
  TYPESTRING16(n##0, x), TYPESTRING16(n##1, x), TYPESTRING16(n##2, x), TYPESTRING16(n##3, x), TYPESTRING16(n##4, x),     \
      TYPESTRING16(n##5, x), TYPESTRING16(n##6, x), TYPESTRING16(n##7, x), TYPESTRING16(n##8, x), TYPESTRING16(n##9, x), \
      TYPESTRING16(n##A, x), TYPESTRING16(n##B, x), TYPESTRING16(n##C, x), TYPESTRING16(n##D, x), TYPESTRING16(n##E, x), \
      TYPESTRING16(n##F, x)
...
#define TYPESTRING1024(n, x)                                                                                                  \
  TYPESTRING256(n##0, x), TYPESTRING256(n##1, x), TYPESTRING256(n##2, x), TYPESTRING128(n##3, x), TYPESTRING16(n##38, x),     \
      TYPESTRING16(n##39, x), TYPESTRING16(n##3A, x), TYPESTRING16(n##3B, x), TYPESTRING16(n##3C, x), TYPESTRING16(n##3D, x), \
      TYPESTRING16(n##3E, x), TYPESTRING16(n##3F, x)

//*~ part4 : Let's give some logic with a -DUSE_TYPESTRING flag!

#ifdef USE_TYPESTRING
#if USE_TYPESTRING == 0
#define ct_string(x) decltype(std_utils::typeek(std_utils::typestring<TYPESTRING1(, x)>()))
#elif USE_TYPESTRING == 1
#define ct_string(x) decltype(std_utils::typeek(std_utils::typestring<TYPESTRING2(, x)>()))
#elif USE_TYPESTRING == 2
#define ct_string(x) decltype(std_utils::typeek(std_utils::typestring<TYPESTRING4(, x)>()))
#elif USE_TYPESTRING == 3
#define ct_string(x) decltype(std_utils::typeek(std_utils::typestring<TYPESTRING8(, x)>()))
#elif USE_TYPESTRING == 4
#define ct_string(x) decltype(std_utils::typeek(std_utils::typestring<TYPESTRING16(, x)>()))
#elif USE_TYPESTRING == 5
#define ct_string(x) decltype(std_utils::typeek(std_utils::typestring<TYPESTRING32(, x)>()))
#elif USE_TYPESTRING == 6
#define ct_string(x) decltype(std_utils::typeek(std_utils::typestring<TYPESTRING64(, x)>()))
#elif USE_TYPESTRING == 7
#define ct_string(x) decltype(std_utils::typeek(std_utils::typestring<TYPESTRING128(, x)>()))
#elif USE_TYPESTRING == 8
#define ct_string(x) decltype(std_utils::typeek(std_utils::typestring<TYPESTRING256(, x)>()))
#elif USE_TYPESTRING == 9
#define ct_string(x) decltype(std_utils::typeek(std_utils::typestring<TYPESTRING512(, x)>()))
#elif USE_TYPESTRING == 10
#define ct_string(x) decltype(std_utils::typeek(std_utils::typestring<TYPESTRING1024(, x)>()))
#elif USE_TYPESTRING > 10
