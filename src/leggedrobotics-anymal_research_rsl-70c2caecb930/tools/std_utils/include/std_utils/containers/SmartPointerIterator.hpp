...
struct smart_pointer_iterator : public base_iterator_ {
...
template <typename base_iterator_, typename element_type_>
struct smart_pointer_pair_iterator : public base_iterator_ {
  using base_iterator = base_iterator_;
  using value_type = typename base_iterator::value_type;
  using element_type = element_type_;

  using pointer = std::pair<typename value_type::first_type, element_type*>;
  using ppointer = std::pair<typename value_type::first_type, element_type**>;
...
smart_pointer_iterator<iterator_, element_type_> dereference_iterator(
    iterator_ t, typename std::enable_if<std_utils::traits::is_smart_ptr<typename iterator_::value_type>::value>::type* = nullptr) {
...
smart_pointer_pair_iterator<iterator_, element_type_> dereference_iterator(
    iterator_ t, typename std::enable_if<std_utils::traits::is_pair_of_smart_ptr<typename iterator_::value_type>::value>::type* = nullptr) {
