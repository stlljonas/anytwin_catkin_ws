  ...
  static constexpr Enum_ mapIdToEnum(const int id) {
    return containsId(id) ? static_cast<Enum_>(0)
                          : throw std::out_of_range(std::string{"[CompileTimeKeys] Tried to map id that is not "
                                                    ...
                                                    std::string{typeid(Enum_).name()} + std::string{" id value: "} + std::to_string(id));
  }
  ...
  static constexpr Enum_ mapNameToEnum(const char* name) {
    return containsName(name)
               ...
               : throw std::out_of_range(std::string{"[CompileTimeKeys] Tried to map name that is not contained in the "
                                         ...
                                         std::string{typeid(Enum_).name()} + std::string{" name value: "} + std::string(name));
  }
...
class CompileTimeKeys<Enum_, CompileTimeKey<Enum_, e_, Name_, id_>, REST_...> {
 ...
 public:
  ...
  static constexpr const std_utils::KeyArray<Enum_, sizeof...(REST_) + 1> getKeysArray() {
    return std_utils::KeyArray<Enum_, sizeof...(REST_) + 1>{
        {std_utils::Key<Enum_>{e_, Name_::data(), id_}, std_utils::Key<Enum_>{REST_::getEnum(), REST_::getName(), REST_::getId()}...}};
  }
  ...
  */
  static constexpr int mapEnumToId(const Enum_ e) { return e == e_ ? id_ : CompileTimeKeys<Enum_, REST_...>::mapEnumToId(e); }
  ...
  */
  ...
  /*! \brief Default implementation of mapIdToEnum().
      ...
      Throws std::out_of_range exception otherwise.
  */
  static constexpr Enum_ mapIdToEnum(const int id) { return id == id_ ? e_ : CompileTimeKeys<Enum_, REST_...>::mapIdToEnum(id); }
  ...
  */
  ...
  /*! \brief Default implementation of containsEnum().
      ...
      \return false.
  */
  static constexpr bool containsEnum(const Enum_ e) { return e == e_ ? true : CompileTimeKeys<Enum_, REST_...>::containsEnum(e); }
  ...
  */
  ...
  /*! \brief Default implementation of containsId().
      ...
      \return false.
  */
  static constexpr bool containsId(const int id) { return id == id_ ? true : CompileTimeKeys<Enum_, REST_...>::containsId(id); }
  ...
  */
  static constexpr bool uniqueEnum(const Enum_ e) { return e == e_ ? false : CompileTimeKeys<Enum_, REST_...>::uniqueEnum(e); }
  ...
  */
  static constexpr bool uniqueId(const int id) { return id == id_ ? false : CompileTimeKeys<Enum_, REST_...>::uniqueId(id); }
};
...
struct ctk_erase<Enum_, CompileTimeKeys<Enum_, CompileTimeKey<Enum_, key_enum, key_name, key_id>, Keys_...>, erase_key> {
  using type =
      typename std::conditional<key_enum == erase_key, CompileTimeKeys<Enum_, Keys_...>,
...
struct ctk_increment_ids<Enum_, CompileTimeKeys<Enum_, CompileTimeKey<Enum_, key_enum, key_name, key_id>, Keys_...>, Increment_> {
  using type = ctk_insert_front_t<Enum_, typename ctk_increment_ids<Enum_, CompileTimeKeys<Enum_, Keys_...>, Increment_>::type,
...
//! @brief Template specialization for CompileTimeKeys of same Enum-type
template <typename TransformedEnum_, typename Enum_, Enum_ key_enum, typename key_name, int key_id, typename... Keys_, typename... KV_,
          int IdOffset_>
struct ctk_transform<TransformedEnum_, CompileTimeKeys<Enum_, CompileTimeKey<Enum_, key_enum, key_name, key_id>, Keys_...>,
                     CompileTimeMap<Enum_, TransformedEnum_, KV_...>, IdOffset_> {
  using type = ctk_insert_front_t<
      TransformedEnum_,
      typename ctk_transform<TransformedEnum_, CompileTimeKeys<Enum_, Keys_...>, CompileTimeMap<Enum_, TransformedEnum_, KV_...>,
                             IdOffset_>::type,
      CompileTimeKey<TransformedEnum_, CompileTimeMap<Enum_, TransformedEnum_, KV_...>::at(key_enum), key_name, IdOffset_ + key_id>>;
};
...
template <typename Enum1_, typename Enum2_, typename TransformedEnum_, typename... Keys1_, typename... Keys2_, typename... KV1_,
          typename... KV2_>
struct ctk_combine<TransformedEnum_, CompileTimeKeys<Enum1_, Keys1_...>, CompileTimeKeys<Enum2_, Keys2_...>,
                   CompileTimeMap<Enum1_, TransformedEnum_, KV1_...>, CompileTimeMap<Enum2_, TransformedEnum_, KV2_...>> {
  using type = std_utils::ctk_concatenate_t<
      TransformedEnum_,
      std_utils::ctk_transform_t<TransformedEnum_, CompileTimeKeys<Enum1_, Keys1_...>, CompileTimeMap<Enum1_, TransformedEnum_, KV1_...>>,
      std_utils::ctk_transform_t<TransformedEnum_, CompileTimeKeys<Enum2_, Keys2_...>, CompileTimeMap<Enum2_, TransformedEnum_, KV2_...>,
