...
using mapAB1 =
    std_utils::CompileTimeMap<EnumA, EnumB, kvAB<EnumA::A_0, EnumB::B_0>, kvAB<EnumA::A_1, EnumB::B_1>, kvAB<EnumA::A_2, EnumB::B_2>>;
using mapAB2 = std_utils::CompileTimeMap<EnumA, EnumB, kvAB<EnumA::A_3, EnumB::B_3>, kvAB<EnumA::A_4, EnumB::B_4>>;

using mapAB = std_utils::CompileTimeMap<EnumA, EnumB, kvAB<EnumA::A_0, EnumB::B_0>, kvAB<EnumA::A_1, EnumB::B_1>,
                                        kvAB<EnumA::A_2, EnumB::B_2>, kvAB<EnumA::A_3, EnumB::B_3>, kvAB<EnumA::A_4, EnumB::B_4>>;

using mapABDuplicates = std_utils::CompileTimeMap<EnumA, EnumB, kvAB<EnumA::A_0, EnumB::B_0>, kvAB<EnumA::A_1, EnumB::B_1>,
                                                  kvAB<EnumA::A_2, EnumB::B_0>, kvAB<EnumA::A_3, EnumB::B_3>, kvAB<EnumA::A_4, EnumB::B_0>>;

using mapAUint = std_utils::CompileTimeMap<EnumA, unsigned int, kvAUint<EnumA::A_0, 2u>, kvAUint<EnumA::A_1, 6u>, kvAUint<EnumA::A_2, 1u>>;

using mapA1A = std_utils::CompileTimeMap<EnumA1, EnumA, kvA1A<EnumA1::A_0, EnumA::A_0>, kvA1A<EnumA1::A_1, EnumA::A_1>,
                                         kvA1A<EnumA1::A_2, EnumA::A_2>>;

using mapB1B = std_utils::CompileTimeMap<EnumB1, EnumB, kvB1B<EnumB1::B_0, EnumB::B_0>, kvB1B<EnumB1::B_1, EnumB::B_1>,
                                         kvB1B<EnumB1::B_2, EnumB::B_2>>;

using mapA1B1 = std_utils::CompileTimeMap<EnumA1, EnumB1, kvA1B1<EnumA1::A_0, EnumB1::B_0>, kvA1B1<EnumA1::A_1, EnumB1::B_1>,
                                          kvA1B1<EnumA1::A_2, EnumB1::B_2>>;

using mapA2A = std_utils::CompileTimeMap<EnumA2, EnumA, kvA2A<EnumA2::A_3, EnumA::A_3>, kvA2A<EnumA2::A_4, EnumA::A_4>>;

using mapB2B = std_utils::CompileTimeMap<EnumB2, EnumB, kvB2B<EnumB2::B_3, EnumB::B_3>, kvB2B<EnumB2::B_4, EnumB::B_4>>;

using mapA2B2 = std_utils::CompileTimeMap<EnumA2, EnumB2, kvA2B2<EnumA2::A_3, EnumB2::B_3>, kvA2B2<EnumA2::A_4, EnumB2::B_4>>;
...
template <EnumA enumA, EnumB enumB>
struct FunctorRange {
  bool operator()(int& counter, int increment) {
    counter += increment;
    return enumA != EnumA::A_1;
  }
};
...
TEST(CompileTimeMap, findAll) {  // NOLINT
...
TEST(CompileTimeMap, findAllRuntime) {  // NOLINT
  ...
  EXPECT_EQ(3u, duplicatesVector.size());
}

TEST(CompileTimeMap, forEachFunctor) {  // NOLINT
...
TEST(CompileTimeMap, forEachStdFunction) {  // NOLINT
  int counter = 0;
...
TEST(CompileTimeMap, forEachRangeFunctor) {  // NOLINT
...
TEST(CompileTimeMap, forEachRangeStdFunction) {  // NOLINT
  constexpr int increment = 2;
  int counter = 0;
  auto f = [&counter, increment](const EnumA& enumA, const EnumB& /*enumB*/) {
    counter += increment;
    return enumA != EnumA::A_1;
  };
...
TEST(CompileTimeMap, at) {  // NOLINT
  ...
  EXPECT_THROW(mapAB::at(EnumA::SIZE), std::out_of_range);  // NOLINT
}

TEST(CompileTimeMap, find) {  // NOLINT
  ...
  EXPECT_THROW(mapAB::find(EnumB::SIZE), std::out_of_range);  // NOLINT
}

TEST(CompileTimeMap, contains) {  // NOLINT
...
TEST(CompileTimeMap, containsRange) {  // NOLINT
...
TEST(CompileTimeMap, containsValue) {  // NOLINT
...
TEST(CompileTimeMap, allValuesUnique) {  // NOLINT
...
TEST(CompileTimeMap, size) {  // NOLINT
  constexpr bool isCompileTime = TestCompileTime<std::size_t, mapAB::size()>::value;
  EXPECT_TRUE(isCompileTime);
  EXPECT_EQ(5u, mapAB::size());
  EXPECT_EQ(3u, mapAB1::size());
  EXPECT_EQ(2u, mapAB2::size());
}

TEST(CompileTimeMap, concatenate) {  // NOLINT
...
TEST(CompileTimeMap, insert_back) {  // NOLINT
...
TEST(CompileTimeMap, insert_front) {  // NOLINT
...
TEST(CompileTimeMap, erase) {  // NOLINT
...
TEST(CompileTimeMap, add_to_values) {  // NOLINT
  using mapAUintPlus2 = std_utils::ctm_add_to_values_t<EnumA, unsigned int, mapAUint, 2>;
  EXPECT_EQ(mapAUintPlus2::at(EnumA::A_0), 4u);
  EXPECT_EQ(mapAUintPlus2::at(EnumA::A_1), 8u);
  EXPECT_EQ(mapAUintPlus2::at(EnumA::A_2), 3u);
}

TEST(CompileTimeMap, from_sets) {  // NOLINT
...
TEST(CompileTimeMap, transform) {  // NOLINT
  ...
  EXPECT_EQ(3u, mapA1BTransformed::size());
  ...
  EXPECT_EQ(3u, mapAB1Transformed::size());
...
TEST(CompileTimeMap, combine) {  // NOLINT
...
TEST(CompileTimeMap, from_subenum) {  // NOLINT
...
TEST(CompileTimeMap, invert) {  // NOLINT
