...
using mapEnumA2ToEnumA = std_utils::CompileTimeMap<EnumA2, EnumA, kvA2A<EnumA2::E_1, EnumA::E_1>, kvA2A<EnumA2::E_2, EnumA::E_2>,
                                                   kvA2A<EnumA2::E_3, EnumA::E_3>>;

// Define keys
using ctkAFront = std_utils::CompileTimeKeys<EnumA, std_utils::CompileTimeKey<EnumA, EnumA::E_0, ct_string("E_0"), 5>>;

using ctkABack = std_utils::CompileTimeKeys<EnumA, std_utils::CompileTimeKey<EnumA, EnumA::E_1, ct_string("E_1")>,  // defaults to id:1
...
using ctkA2 = std_utils::CompileTimeKeys<EnumA2, std_utils::CompileTimeKey<EnumA2, EnumA2::E_1, ct_string("E_1")>,  // defaults to id:0
...
using ctkA = std_utils::CompileTimeKeys<EnumA, std_utils::CompileTimeKey<EnumA, EnumA::E_0, ct_string("E_0"), 5>,
...
TEST(CompileTimeKeys, mapEnumToName) {  // NOLINT
  ...
  EXPECT_THROW(ctkA::mapEnumToName(EnumA::SIZE), std::out_of_range);  // NOLINT
}

TEST(CompileTimeKeys, mapEnumToId) {  // NOLINT
  ...
  EXPECT_THROW(ctkA::mapEnumToId(EnumA::SIZE), std::out_of_range);  // NOLINT
}

TEST(CompileTimeKeys, mapIdToEnum) {  // NOLINT
  ...
  EXPECT_THROW(ctkA::mapIdToEnum(0), std::out_of_range);  // NOLINT
}

TEST(CompileTimeKeys, mapIdToName) {  // NOLINT
  ...
  EXPECT_THROW(ctkA::mapIdToName(0), std::out_of_range);  // NOLINT
}

TEST(CompileTimeKeys, mapNameToEnum) {  // NOLINT
  ...
  EXPECT_THROW(ctkA::mapNameToEnum("SIZE"), std::out_of_range);  // NOLINT
}

TEST(CompileTimeKeys, mapNameToId) {  // NOLINT
  ...
  EXPECT_THROW(ctkA::mapNameToId("SIZE"), std::out_of_range);  // NOLINT
}

TEST(CompileTimeKeys, containsEnum) {  // NOLINT
...
TEST(CompileTimeKeys, containsName) {  // NOLINT
...
TEST(CompileTimeKeys, containsId) {  // NOLINT
...
TEST(CompileTimeKeys, size) {  // NOLINT
  constexpr bool isCompileTime = TestCompileTime<std::size_t, ctkA::size()>::value;
  EXPECT_TRUE(isCompileTime);
  EXPECT_EQ(1u, ctkAFront::size());
  EXPECT_EQ(3u, ctkABack::size());
  EXPECT_EQ(4u, ctkA::size());
}

TEST(CompileTimeKeys, keysArray) {  // NOLINT
  auto keyContainer = ctkA::getKeysArray();
  EXPECT_EQ(strcmp("E_0", keyContainer.at(EnumA::E_0).getName()), 0);
  EXPECT_EQ(5u, keyContainer.atId(5).getId());
  EXPECT_EQ(strcmp("E_0", keyContainer.atId(5).getName()), 0);
  EXPECT_EQ(EnumA::E_0, keyContainer.atId(5).getEnum());
  EXPECT_EQ(1u, keyContainer.at(EnumA::E_1).getId());
  EXPECT_EQ(strcmp("E_1", keyContainer.at(EnumA::E_1).getName()), 0);
  EXPECT_EQ(12u, keyContainer.get<EnumA::E_2>().getId());
  EXPECT_EQ(EnumA::E_2, keyContainer.atId(12).getEnum());
  EXPECT_EQ(5u, keyContainer.atName("E_0").getId());
  EXPECT_EQ(4u, keyContainer.size());
}

TEST(CompileTimeKeys, concatenate) {  // NOLINT
...
TEST(CompileTimeKeys, insert_back) {  // NOLINT
  using ctkA_ib = std_utils::ctk_insert_back_t<EnumA, ctkAFront, std_utils::CompileTimeKey<EnumA, EnumA::E_1, ct_string("E_1")>>;
  using ctkA_ib2 = std_utils::ctk_insert_back_t<EnumA, ctkA_ib, std_utils::CompileTimeKey<EnumA, EnumA::E_2, ct_string("E_2"), 12>>;
  using ctkA_ib3 = std_utils::ctk_insert_back_t<EnumA, ctkA_ib2, std_utils::CompileTimeKey<EnumA, EnumA::E_3, ct_string("E_3")>>;
  constexpr bool ctkABackInsertionSuccessful = std::is_same<ctkA_ib3, ctkA>::value;
  EXPECT_TRUE(ctkABackInsertionSuccessful);
}

TEST(CompileTimeKeys, insert_front) {  // NOLINT
  using ctkA_if = std_utils::ctk_insert_front_t<EnumA, ctkABack, std_utils::CompileTimeKey<EnumA, EnumA::E_0, ct_string("E_0"), 5>>;
  constexpr bool ctkAFrontInsertionSuccessful = std::is_same<ctkA_if, ctkA>::value;
  EXPECT_TRUE(ctkAFrontInsertionSuccessful);
}

TEST(CompileTimeKeys, erase) {  // NOLINT
...
TEST(CompileTimeKeys, pop_front) {  // NOLINT
...
TEST(CompileTimeKeys, increment_ids) {  // NOLINT
  ...
  EXPECT_THROW(ctkA_ids::mapEnumToId(EnumA::SIZE), std::out_of_range);  // NOLINT
}

TEST(CompileTimeKeys, pop_front_and_decrement) {  // NOLINT
  ...
  EXPECT_THROW(ctkA_pfd::mapEnumToId(EnumA::E_0), std::out_of_range);   // NOLINT
  EXPECT_THROW(ctkA_pfd::mapEnumToId(EnumA::SIZE), std::out_of_range);  // NOLINT
}

TEST(CompileTimeKeys, transform) {  // NOLINT
...
TEST(CompileTimeKeys, combine) {  // NOLINT
