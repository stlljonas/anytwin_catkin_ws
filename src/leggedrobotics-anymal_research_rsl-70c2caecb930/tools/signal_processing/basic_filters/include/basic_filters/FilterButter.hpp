 ...
 *     Order	Delay	Order	Delay	Order	Delay
   ...
   @article{Manal2007678,
        title = "A general solution for the time delay introduced by a low-pass Butterworth digital filter: An application to
 musculoskeletal modeling", journal = "Journal of Biomechanics", volume = "40", number = "3", pages = "678 - 681", year = "2007", note = "",
        issn = "0021-9290",
