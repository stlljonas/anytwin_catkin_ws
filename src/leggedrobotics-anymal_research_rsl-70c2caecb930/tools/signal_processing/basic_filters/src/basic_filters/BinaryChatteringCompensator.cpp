...
BinaryChatteringCompensator::BinaryChatteringCompensator() : state_(false), active_(false), time_(0.0), timeBound_(0.0) {}

BinaryChatteringCompensator::~BinaryChatteringCompensator() = default;
