...
#include <basic_controllers/PidEigen.hpp>

TEST(PidEigen, PiDEigenTest) {  // NOLINT
  ...
  basic_controllers::PidEigen fixedSizePid(zerosFixedSize, zerosFixedSize, zerosFixedSize, zerosFixedSize, zerosFixedSize, zerosFixedSize,
                                           zerosFixedSize);
  ...
  basic_controllers::PidEigen fixedSizePidInit(pGains, iGains, dGains, iMax, iMin, cmdMax, cmdMin);
  ...
  cmdMaxDyn = cmdMax;
  cmdMinDyn = cmdMin;
  basic_controllers::PidEigen dynamicSizePid(pGainsDyn, iGainsDyn, dGainsDyn, iMaxDyn, iMinDyn, cmdMaxDyn, cmdMinDyn);
