...
#include <basic_controllers/DiscretePidEigen.hpp>

TEST(DiscretePidEigen, DiscretePidEigenTest) {  // NOLINT
  std::srand(0xbeef);                           // Fix seed for reproducibility
  ...
  basic_controllers::DiscretePidEigen fixedSizePid(zerosFixedSize, zerosFixedSize, zerosFixedSize, zerosFixedSize, zerosFixedSize);
  ...
  basic_controllers::DiscretePidEigen fixedSizePidInit(pGains, iGains, dGains, cmdMax, cmdMin);
  ...
  cmdMaxDyn = cmdMax;
  cmdMinDyn = cmdMin;
  basic_controllers::DiscretePidEigen dynamicSizePid(pGainsDyn, iGainsDyn, dGainsDyn, cmdMaxDyn, cmdMinDyn);
