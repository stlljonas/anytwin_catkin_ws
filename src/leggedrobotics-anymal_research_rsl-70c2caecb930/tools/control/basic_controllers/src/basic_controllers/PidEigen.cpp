...
PidEigen::PidEigen(const MatrixXd& pGains, const MatrixXd& iGains, const MatrixXd& dGains, const MatrixXd& iMax, const MatrixXd& iMin,
                   const MatrixXd& cmdMax, const MatrixXd& cmdMin) {
  init(pGains, iGains, dGains, iMax, iMin, cmdMax, cmdMin);
}

void PidEigen::init(const MatrixXd& pGains, const MatrixXd& iGains, const MatrixXd& dGains, const MatrixXd& iMax, const MatrixXd& iMin,
                    const MatrixXd& cmdMax, const MatrixXd& cmdMin) {
  // assert same sizes
