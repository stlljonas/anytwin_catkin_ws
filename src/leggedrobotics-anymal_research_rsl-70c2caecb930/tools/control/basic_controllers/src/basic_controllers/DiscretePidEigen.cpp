...
DiscretePidEigen::DiscretePidEigen(const MatrixXd& pGains, const MatrixXd& iGains, const MatrixXd& dGains, const MatrixXd& cmdMax,
                                   const MatrixXd& cmdMin) {
  init(pGains, iGains, dGains, cmdMax, cmdMin);
}

void DiscretePidEigen::init(const MatrixXd& pGains, const MatrixXd& iGains, const MatrixXd& dGains, const MatrixXd& cmdMax,
                            const MatrixXd& cmdMin) {
  // assert same sizes
