...
inline sensor_msgs::Imu::_linear_acceleration_covariance_type toRos(
    const any_measurements::ImuWithCovariance::CovarianceMatrix& covariance) {
  return ConversionTraits<any_measurements::ImuWithCovariance::CovarianceMatrix,
                          sensor_msgs::Imu::_linear_acceleration_covariance_type>::convert(covariance);
}
...
inline any_measurements::ImuWithCovariance::CovarianceMatrix fromRos(const sensor_msgs::Imu::_linear_acceleration_covariance_type& msg) {
  return ConversionTraits<any_measurements::ImuWithCovariance::CovarianceMatrix,
                          sensor_msgs::Imu::_linear_acceleration_covariance_type>::convert(msg);
}
...
inline geometry_msgs::PoseWithCovariance::_covariance_type toRos(const any_measurements::PoseWithCovariance::CovarianceMatrix& covariance) {
  return ConversionTraits<any_measurements::PoseWithCovariance::CovarianceMatrix,
                          geometry_msgs::PoseWithCovariance::_covariance_type>::convert(covariance);
}
...
inline any_measurements::PoseWithCovariance::CovarianceMatrix fromRos(const geometry_msgs::PoseWithCovariance::_covariance_type& msg) {
  return ConversionTraits<any_measurements::PoseWithCovariance::CovarianceMatrix,
                          geometry_msgs::PoseWithCovariance::_covariance_type>::convert(msg);
}
