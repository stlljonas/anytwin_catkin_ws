...
class SubscriberOptions : public CommunicatorOptions {
 public:
   ...
   */
  SubscriberOptions(const std::string& topic, const SubscriberCallback& callback) : SubscriberOptions(topic, callback, false, 0) {}
   ...
   *                                     set to true
   */
  SubscriberOptions(const std::string& topic, SubscriberCallback callback, bool autoSubscribe, int autoSubscriberPriority)
 ...
 public:
  ...
  bool autoSubscribe_ = false;

  //! Priority of the subscriber thread (0...99) 0 = lowest prio
  int autoSubscriberPriority_ = 0;
