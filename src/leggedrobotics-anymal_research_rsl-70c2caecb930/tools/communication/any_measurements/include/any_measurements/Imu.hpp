...
struct Imu {
 public:
  ...
  Imu(const Time& time, const kindr::RotationQuaternionD& orientation, const kindr::LocalAngularVelocityD& angularVelocity,
      const kindr::Acceleration3D& linearAcceleration)
      : time_(time), orientation_(orientation), angularVelocity_(angularVelocity), linearAcceleration_(linearAcceleration) {}
