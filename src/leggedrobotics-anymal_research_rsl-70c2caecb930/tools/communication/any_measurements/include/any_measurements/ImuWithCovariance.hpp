...
struct ImuWithCovariance : public Imu {
 public:
  ...
  ImuWithCovariance(const Time& time, const kindr::RotationQuaternionD& orientation, const kindr::LocalAngularVelocityD& angularVelocity,
                    const kindr::Acceleration3D& linearAcceleration, const CovarianceMatrix& orientationCovariance,
                    const CovarianceMatrix& angularVelocityCovariance, const CovarianceMatrix& linearAccelerationCovariance)
