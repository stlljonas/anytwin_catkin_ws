...
struct ImuWithTrigger : public Imu {
 public:
  ...
  ImuWithTrigger(const Time& time, const kindr::RotationQuaternionD& orientation, const kindr::LocalAngularVelocityD& angularVelocity,
                 const kindr::Acceleration3D& linearAcceleration, bool triggerIndicator)
      : Base(time, orientation, angularVelocity, linearAcceleration), triggerIndicator_(triggerIndicator) {}
