...
class DiagnosticComponentLmc : public DiagnosticComponentBase {
public:
  ...
  DiagnosticComponentLmc();

  DiagnosticComponentLmc(const QString &name, const QString &id, QPoint point,
