...
rosrun xacro xacro.py -o $(rospack find anymal_model)/resources/$1_$2_fixed.urdf $(rospack find $1_description)/urdf/$1_$2.urdf.xacro simulation:=true fixed:=true perfect_sensors:=true hooks:=false
